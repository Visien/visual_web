...
import systemconfRouter from './modules/systemconf'
import videostreamRouter from './modules/videostream'
import aialgorithmRouter from './modules/aialgorithm'
import bodyanalysisRouter from './modules/bodyanalysis'
import postalindustryRouter from './modules/postalindustry'
import oilfieldRouter from './modules/oilfield'
...
export const asyncRoutes: RouteConfig[] = [
  ...
  //     {
  //       path: 'index',
  //       component: () => import(/* webpackChunkName: "icons" */ '@/views/videostream/index.vue'),
  //       name: 'videoStream',
  //       meta: {
  //         title: 'videoStream',
  //         icon: 'tree',
